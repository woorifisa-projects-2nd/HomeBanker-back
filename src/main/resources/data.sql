-- INSERT INTO `customer` (`customer_id`, `customer_name`, `customer_birth`, `customer_phone`,
--                         `customer_address`, `customer_login_id`, `customer_login_pw`,
--                         `customer_role`,
--                         `customer_identification_num`, `customer_recent_login`, `join_date`)
-- VALUES (1, '홍길동', '1990-01-01', '01012345678',
...
INSERT INTO `employee` (`employee_id`, `employee_name`, `employee_department`, `employee_grade`,
                        `employee_login_id`, `employee_login_pw`, `employee_role`, `recent_login`)
VALUES (1, '김갑수', '판매', '사원', 'cap123', 'pass123', 'banker', '2023-04-03 10:17:55'),
